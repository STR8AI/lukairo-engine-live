...
(function (window) {
  ...
  const defaultConfig = {
    ...
    layers: {
      gears: { radius: 1.0, speed: 0.003, reverse: false, opacity: 0.12 },
      circuits: { radius: 1.5, speed: 0.002, reverse: true, opacity: 0.18 },
      globe: { radius: 2.0, speed: 0.001, reverse: false, opacity: 0.88 },
    },
    starfield: {
      count: 1200,
      radius: 50,
  ...
  class NeuralCore {
    ...
    setupLighting() {
      ...
      const pointLight1 = new THREE.PointLight(0x6cead9, 1.15, 100);
    ...
    createLayer(name, texture) {
      ...
      const material = new THREE.MeshPhongMaterial({
        ...
        alphaTest: isGlobe ? 0.28 : 0,
        side: THREE.FrontSide,
        depthWrite: true,
        wireframe: !texture,
        emissive: isGlobe ? 0x163640 : 0x000000,
        emissiveIntensity: isGlobe ? 0.12 : 0,
      });
